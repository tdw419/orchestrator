...
export type ActionType = 'screenshot' | 'move_mouse' | 'click_mouse' | 'scroll' | 'type_text' | 'key_press' | 'open_app' | 'run_powershell' | 'autodev_run' | 'verify_result' | 'spawn_subtask' | 'spawn_template' | 'done';
export type VerificationMethod = 'file_exists' | 'api_call' | 'test' | 'extension_command' | 'vscode_test';
export type ErrorType = 'timeout' | 'permission' | 'network' | 'resource' | 'syntax' | 'missing_dependency' | 'server_error' | 'client_error' | 'nonzero_exit' | 'error_flag' | 'unknown';
export type RetryStrategy = 'wait_longer' | 'escalate_privileges' | 'retry_connection' | 'reduce_load' | 'fix_syntax' | 'install_dependency' | 'debug_approach';
