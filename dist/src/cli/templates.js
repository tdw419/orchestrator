...
exports.runTemplateCli = runTemplateCli;
const run_1 = require("../api/templates/run");
...
const defaultDependencies = {
    runTemplateTask: run_1.runTemplateTask,
    runner: {
        loadTemplate: async () => {
...
async function runTemplateCli(argv, io = defaultIO, dependencies = defaultDependencies) {
    if (argv.length < 3) {
