...
class ChatViewProvider {
    ...
    async handleUserMessage(text) {
        ...
        try {
            ...
            const apiBase = config.get('apiUrl', 'http://localhost:1234/v1');
            const model = config.get('modelName', 'lmstudio-local');
            const system = config.get('systemPrompt', 'You are a helpful coding assistant inside VS Code. Be concise and provide actionable answers.');
...
ChatViewProvider.viewType = 'lmstudio.chatView';
